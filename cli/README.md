...
Point your coding agent at a [cortex](https://github.com/tashfeenahmed/CORTEX)
...
```bash
npx cortex setup-claude --url http://localhost:3001 --api-key <your-key>
```

No install step, no account. The unified API key comes from your cortex
...
`CORTEX_URL` and `CORTEX_API_KEY` work in place of `--url` / `--api-key`.
...
Node.js >= 20.18. A running cortex gateway
([install guide](https://github.com/tashfeenahmed/CORTEX/blob/main/docs/install.md)).

## Links

- [Clients & coding agents guide](https://github.com/tashfeenahmed/CORTEX/blob/main/docs/clients.md)
- [Issue tracker](https://github.com/tashfeenahmed/CORTEX/issues)
