...
export function AuthGate({ children }: { children: ReactNode }) {
  ...
  // Build-time escape hatch: when VITE_DISABLE_AUTH is set, skip the dashboard
  // login/setup gate entirely and render the app. The /v1 inference proxy keeps
  // its own unified-key auth, so this only opens the admin UI without a session.
